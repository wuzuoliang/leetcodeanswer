...
func Test621(t *testing.T) {
	t.Log(leastInterval([]byte{'A', 'A', 'A', 'B', 'B', 'B'}, 2))                               // 8
	t.Log(leastInterval([]byte{'A', 'A', 'A', 'B', 'B', 'B'}, 0))                               // 6
	t.Log(leastInterval([]byte{'A', 'A', 'A', 'B', 'B', 'B'}, 50))                              // 104
	t.Log(leastInterval([]byte{'A', 'A', 'A', 'A', 'A', 'A', 'B', 'C', 'D', 'E', 'F', 'G'}, 2)) //16
}
